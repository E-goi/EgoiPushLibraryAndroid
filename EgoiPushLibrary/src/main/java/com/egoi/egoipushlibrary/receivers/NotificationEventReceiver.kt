...
import com.egoi.egoipushlibrary.workers.RegisterEventWorker
...
class NotificationEventReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val NOTIFICATION_OPEN: String = "com.egoi.action.NOTIFICATION_OPEN"
        const val NOTIFICATION_EVENT_VIEW: String = "com.egoi.action.NOTIFICATION_EVENT_VIEW"
        const val NOTIFICATION_EVENT_CLOSE: String = "com.egoi.action.NOTIFICATION_EVENT_CLOSE"
    }
